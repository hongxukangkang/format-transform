...
public abstract class Button extends RelativeLayout {
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(getWidth() - dpToPx(6, getResources()), getHeight() - dpToPx(7, getResources()), Config.ARGB_8888);
    ...
    public void setBackgroundColor(int color) {
        ...
        GradientDrawable shape = (GradientDrawable) layer.findDrawableByLayerId(com.personal.format.R.id.shape_bacground);
